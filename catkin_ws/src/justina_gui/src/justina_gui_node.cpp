...
int main(int argc, char** argv)
{
    ...
    if(la_predefined_file != "") yamlParser.loadLaPredefinedPositions(la_predefined_file);
    if(ra_predefined_file != "") yamlParser.loadRaPredefinedPositions(ra_predefined_file);
    if(hd_predefined_file != "") yamlParser.loadHdPredefinedPositions(hd_predefined_file);
