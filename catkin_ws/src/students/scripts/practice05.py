...
def rejection_force(robot_x, robot_y, robot_a, laser_readings):
	...
	mag=magnitude
	force_x,force_y=force_x+mag*math.cos(angle+robot_a),force_y+mag*math.sin(angle+robot_a)
...
def callback_pot_fields_goal(msg):
    ...
    #     Call draw_force_markers(robot_x, robot_y, afx, afy, rfx, rfy, fx, fy, pub_markers)  to draw all forces
    	draw_force_markers(robot_x, robot_y, fax, fay, frx, fry, Fx, Fx, pub_markers) 
    #
