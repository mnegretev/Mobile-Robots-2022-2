...
NAME = "SANJUAN ALDAPE DIANA PAOLA"
...
def parse_command(cmd):
    ...
    loc = [6.94,-1.19] if "TABLE" in cmd else [3.13, 9.0]
    #loc = [8.2,8.5] if "TABLE" in cmd else [3.13, 9.0]
    return obj, loc
...
def main():
    global new_task, recognized_speech, executing_task, goal_reached, aux
    global pubLaGoalPose, pubRaGoalPose, pubHdGoalPose, pubLaGoalGrip, pubRaGoalGrip
    global pubGoalPose, pubCmdVel, pubSay, pub_goal_reached, loop, listener
